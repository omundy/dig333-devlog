...
- The voltage drop from my 1 kilo ohm resistor and the green LED was 7.61V from the original 9V. The voltage dropped further with the red LED from 7.61V to 5.36V. Finally the voltage dropped 5.36V to 3.52V when connected to a blue LED.
...
- ( https://www.tinkercad.com/things/jFqJP4Jg2PX-week02devlog/editel?returnTo=https%3A%2F%2Fwww.tinkercad.com%2Fdashboard%2Fdesigns%2Fall )
...
- For this week's chapter, I found Mr. Pearson's introduction of electricity to be quite intriguing and amusing. I like how he likened it to the mechanical world and stating the fact that their only differences are the fact that they operate on a totally different set of rules. I also appreciated the breakdown of electricity in such an understandable way and the provision of illustrations to make it mroe relatable
...
- The video documentation of my musical instrument is saved in this google drive folder. ( https://drive.google.com/drive/u/0/folders/1Ic6HQ47hFD2-g0eAT86duXwh78u2Lel2 )
...
- This is because, capacitors store and discharge charges, like the bucket analogy. If you connect this to an extremely high voltage, storing too much water in the bucket. It could blow up which is extremely dangerous. 



7\. What is the difference between an analog and digital component?
- Analog components are mechanical in nature with a continous value flow, while digital components use set countable values, or that is how I kind of understood it. 
...
- ( https://www.youtube.com/watch?v=SPyyovWN6Bw&list=RDSPyyovWN6Bw&start_radio=1 ) This is M83's Raconte Moi-Une Histoire. It starts witha synth kepyboard which pushes the notes in a short and pushy manner, but then it has some feedback bleed at the end, the notes are then harmonized and joined in by a guitar, drums, and vocals. Later in the track, a synth keyboard on sustain is added.
